      ...
      <section>
        ...
        <div className="space-y-2">
          <label className="flex items-start gap-2">
            ...
            <span>Saya menyatakan bahwa data yang saya isi adalah benar.</span>
          </label>
          <label className="flex items-start gap-2">
            <input type="checkbox" required />
            <span>Saya menyetujui kebijakan privasi dan ketentuan magang.</span>
          </label>
          <input
            type="text"
            name="tandaTangan"
            placeholder="Tanda Tangan Digital (opsional)"
            onChange={handleChange}
