      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <Image
                src="/images/rekayasa-perangkat-lunak.jpg"
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mt-4 mb-6 leading-tight">
              Bangun Solusi <br /> Digital Masa Depan.
            </h1>
            <p className="text-gray-600 text-xl mb-6 leading-relaxed">
              Kami telah membina ribuan mahasiswa dalam pengembangan software
              modern. Program ini dirancang untuk memperkuat keahlian di bidang
              coding, UI/UX, pengujian, serta pengelolaan proyek perangkat
              lunak.
            </p>
