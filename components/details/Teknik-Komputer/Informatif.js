      ...
      <div className="max-w-7xl mx-auto">
        ...
        <nav className="text-xl md:text-2xl text-gray-600 mb-8">
          <ol className="flex items-center space-x-3">
            ...
            <li>{">"}</li>
            <li className="text-gray-800 font-semibold">Teknik Komputer</li>
          </ol>
        </nav>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              <Image
                src="/images/teknik-komputer.jpg" // ✅ Ganti file gambar jika belum tersedia
                alt="Teknik Komputer"
                width={600}
                height={400}
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mt-4 mb-6 leading-tight">
              Profesional dan <br /> Berdedikasi di Dunia Teknologi.
            </h1>
            <p className="text-gray-600 text-xl mb-6 leading-relaxed">
              Kami memiliki pengalaman lebih dari 15 tahun dalam membentuk
              talenta unggul di bidang komputer dan jaringan. Program ini
              dirancang untuk mendukung keterampilan praktis di bidang sistem
              tertanam, perangkat keras, dan infrastruktur IT.
            </p>
