  ...
  const features = [
    {
      ...
      description:
        "Mahasiswa belajar langsung merancang dan membangun perangkat berbasis mikrokontroler dan embedded system.",
    },
    {
      icon: <Clock className="w-8 h-8 text-blue-600" />,
      title: "Efisiensi Waktu",
      description:
        "Magang terstruktur dan fleksibel tanpa mengganggu proses akademik.",
    },
    {
      icon: <UserCog className="w-8 h-8 text-blue-600" />,
      title: "Mentor Ahli Hardware",
      description:
        "Didampingi oleh praktisi profesional di bidang jaringan, sistem komputer, dan hardware.",
    },
    {
      icon: <CheckCircle2 className="w-8 h-8 text-blue-600" />,
      title: "Sertifikasi & Portofolio",
      description:
        "Magang dilengkapi sertifikat resmi dan hasil proyek yang dapat digunakan untuk portofolio kerja.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-10 text-center text-gray-800 text-lg font-medium">
          ...
          >
            ...
            <p className="text-sm text-gray-500 mt-1">
              Perusahaan mitra di bidang teknologi dan hardware.
            </p>
          </motion.div>
        </div>
      </div>
